...
const table: Array<[string, Record<string, unknown>, string, Record<string, unknown>]> = [
  ...
  ["masume_set_text_preferences", { ...m, languages: ["en-US"], customWords: [] }, "set_text_preferences",
    { languages: ["en-US"], customWords: [] }],
  ["masume_create_element", { ...m, element: { type: "rounded_rectangle", over: "B2:C3", cornerRadius: 16, shadow: false } },
    "create_element", { type: "rounded_rectangle", over: "B2:C3", cornerRadius: 16, shadow: false }],
  ["masume_create_element", { ...m, element: { type: "highlight", over: "B2:C3", opacity: 0.3 } },
    "create_element", { type: "highlight", over: "B2:C3", opacity: 0.3 }],
